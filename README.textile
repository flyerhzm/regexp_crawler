...
RegexpCrawler is a crawler which uses regex expression to catch data from website. It is easy to use and less code if you are familiar with regex expression.
...
regexp_crawler
A crawler which use regex expression to catch data. 
